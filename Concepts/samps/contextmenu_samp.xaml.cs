...
namespace mysamp_Samp //needs to match the .xaml page
{
    public partial class Page1 : Page
    {
        ...
        private MenuItem _mi, _mia, _mib, _mib1, _mib1A;
        ...
        {
            _btn = new Button {Content = "Create with C#"};
            _contextmenu = new ContextMenu();
            _btn.ContextMenu = _contextmenu;
            _mi = new MenuItem {Header = "File"};
            _mia = new MenuItem {Header = "New"};
            _mi.Items.Add(_mia);
            _mib = new MenuItem {Header = "Open"};
            _mi.Items.Add(_mib);
            _mib1 = new MenuItem {Header = "Recently Opened"};
            _mib.Items.Add(_mib1);
            _mib1A = new MenuItem {Header = "Text.xaml"};
            _mib1.Items.Add(_mib1A);
            _contextmenu.Items.Add(_mi);
            cv2.Children.Add(_btn);
        }
    }
}